 ...
 * Creates basic tables for salon management
 */
...
CREATE INDEX IF NOT EXISTS idx_offerings_category ON offerings(tenant_id, category);
CREATE INDEX IF NOT EXISTS idx_offerings_active ON offerings(tenant_id, is_active);
CREATE INDEX IF NOT EXISTS idx_transactions_tenant ON transactions(tenant_id);
CREATE INDEX IF NOT EXISTS idx_transactions_type ON transactions(tenant_id, transaction_type);
CREATE INDEX IF NOT EXISTS idx_transactions_customer_phone ON transactions(tenant_id, customer_phone);
CREATE INDEX IF NOT EXISTS idx_transactions_offering ON transactions(offering_id);
CREATE INDEX IF NOT EXISTS idx_transactions_scheduled ON transactions(tenant_id, scheduled_at);
CREATE INDEX IF NOT EXISTS idx_transactions_payment_status ON transactions(tenant_id, payment_status);
CREATE INDEX IF NOT EXISTS idx_transactions_created ON transactions(tenant_id, created_at);
CREATE INDEX IF NOT EXISTS idx_conversations_tenant ON conversations(tenant_id);
CREATE INDEX IF NOT EXISTS idx_conversations_phone ON conversations(tenant_id, phone_number);
