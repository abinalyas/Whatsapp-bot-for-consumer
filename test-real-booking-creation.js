 ...
 * Test booking creation with real service data
 */
...
async function testRealBookingCreation() {
  console.log('🧪 Testing Real Booking Creation');
  console.log('================================\n');
...
async function main() {
  console.log('🚀 Test Real Booking Creation');
  console.log('============================\n');
  
  await testRealBookingCreation();
  
  console.log('\n🎯 Expected Results:');
  console.log('- If successful, we know the database insertion works');
  console.log('- If failed, we can see the exact error');
  console.log('- This will help us fix the WhatsApp Bot');
}
